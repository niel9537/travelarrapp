...
public class ListFormManajerAdapter extends RecyclerView.Adapter<ListFormManajerAdapter.MyViewHolder> {
    ...
    public ListFormManajerAdapter(List<ListForm> listForm, Context context) {
        this.listForm = listForm;
        this.context = context;
    }

    @Override
    public ListFormManajerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_listform, parent, false);
        ListFormManajerAdapter.MyViewHolder mViewHolder = new ListFormManajerAdapter.MyViewHolder(mView);
        return mViewHolder;
    }

    @Override
    public void onBindViewHolder(ListFormManajerAdapter.MyViewHolder holder, final int position) {
