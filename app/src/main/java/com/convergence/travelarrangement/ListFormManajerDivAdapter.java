...
public class ListFormManajerDivAdapter extends RecyclerView.Adapter<ListFormManajerDivAdapter.MyViewHolder> {
    List<ListForm> listForm;
    Context context;

    public ListFormManajerDivAdapter(List<ListForm> listForm, Context context) {
        this.listForm = listForm;
        this.context = context;
    }

    @Override
    public ListFormManajerDivAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_listform, parent, false);
        ListFormManajerDivAdapter.MyViewHolder mViewHolder = new ListFormManajerDivAdapter.MyViewHolder(mView);
        return mViewHolder;
    }

    @Override
    public void onBindViewHolder(ListFormManajerDivAdapter.MyViewHolder holder, final int position) {
